    ...
    public partial class initialCreateDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingListDetail", x => x.ShoppingListDetailId);
                    table.ForeignKey(
                        name: "FK_ShoppingListDetail_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingListDetail_ShoppingList_ShoppingListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingListDetail_ItemId",
                table: "ShoppingListDetail",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingListDetail_ShoppingListId",
                table: "ShoppingListDetail",
